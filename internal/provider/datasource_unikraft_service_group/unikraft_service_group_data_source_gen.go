...
package datasource_unikraft_service_group
...
func UnikraftServiceGroupDataSourceSchema(ctx context.Context) schema.Schema {
...
type UnikraftServiceGroupModel struct {
