...
package resource_autoscale_configuration
...
func AutoscaleConfigurationResourceSchema(ctx context.Context) schema.Schema {
...
type AutoscaleConfigurationModel struct {
